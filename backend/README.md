...
## Project Structure
    ...
    ├── sparkling_truth_de_103193  # Django project configurations
...
1. Clone this repo and `cd sparkling_truth_de_103193`
...
2. Clone this repo and `cd sparkling_truth_de_103193`
